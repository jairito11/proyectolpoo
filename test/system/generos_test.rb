...
class GenerosTest < ApplicationSystemTestCase
  ...
  test "creating a Genero" do
    ...
    fill_in "Contexto", with: @genero.contexto
    fill_in "Descripcion", with: @genero.descripcion
    fill_in "Fonologia", with: @genero.fonologia
    fill_in "Genero", with: @genero.genero
    fill_in "Historia", with: @genero.historia
    fill_in "Semantica", with: @genero.semantica
    fill_in "Sintactica", with: @genero.sintactica
    fill_in "Subgenero", with: @genero.subgenero
